import thumbsUp from "@/public/assets/email/order-conf-icon.png"
                                                  ...
                                                  <td class="column column-1"
                                                      ...
                                                      <table border="0" cellpadding="10" cellspacing="0"
                                                          ...
                                                          <tr>
                                                              <td class="pad">
                                                                  <h4
                                                                      style="margin: 0; color: #ffd230; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 20px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 45.6px;">
  
                                                                      <a href="${link}"
                                                                          style="background-color: #ffd230;color:white;padding:10px 30px;text-decoration: none; border-radius: 50px;">Verify</a>
                                                                  </h4>
                                                              ...
                                                              <td class="pad"
                                                                  ...
                                                                  <div
                                                                      ...
                                                                      <p style="margin: 0;">Thank you,<br />
                                                                          <a href="https://github.com/WillowsCosmic"
                                                                              target="_blank">WillowsCosmic</a>
                                                                      </p>
                                                                  </div>
                                                              </td>
                                                          </tr>
